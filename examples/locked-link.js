...
slider1.Link('upper').to(slider2, crossUpdate);
slider1.Link('upper').to($("#slider1-span"));

slider2.Link('upper').to(slider1, crossUpdate);
slider2.Link('upper').to($("#slider2-span"));
