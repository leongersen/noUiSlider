...
<div class="triple">
	...
	<p>When using noUiSlider in your forms, users get all the functionality they've come to expect, and powerful API's make implementation easy. When gzipped and minified, noUiSlider and the default CSS theme take just <strong>5980 Bytes</strong>.</p>
</div>

<div class="triple">
	<h4>Super simple API design</h4>
